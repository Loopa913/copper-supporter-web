...
export function SupporterCards({ 
  supporters, 
  supporterSectionDescription = "스트리머 프로젝트와 함께하는 그룹 멤버들입니다.",
  supporterDescription = "서포터즈 그룹에 대한 설명입니다.", 
  seedPlayerDescription = "시드 플레이어 그룹에 대한 설명입니다." 
}: SupporterCardsProps) {
    ...
    >
      <div className="mx-auto max-w-6xl">
        <SectionHeader
          ...
          title="프로젝트 참여자"
          description={supporterSectionDescription}
          align="center"
        />
